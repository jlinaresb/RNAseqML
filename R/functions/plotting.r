...
png(filename = '~/git/diffExpress/plots/expression_profile.png')
par(mfrow = c(2,1))
...
#MAplot
png(filename = '~/git/diffExpress/plots/MA-plot.png')
...
png(filename = '~/git/diffExpress/plots/metaMDSplot.png')
...
g <- g + theme(legend.direction = 'horizontal',
               legend.position = 'top')
png(filename = '~/git/diffExpress/plots/PCAplot.png')
g
dev.off()