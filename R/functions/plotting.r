...
png(filename = '~/git/RNAseqML/plots/expression_profile.png')
par(mfrow = c(2,1))
...
#MAplot
png(filename = '~/git/RNAseqML/plots/MA-plot.png')
...
png(filename = '~/git/RNAseqML/plots/metaMDSplot.png')
...
g <- g + theme(legend.direction = 'horizontal',
               legend.position = 'top')
png(filename = '~/git/RNAseqML/plots/PCAplot.png')
g
dev.off()